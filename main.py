...
def render_game(screen, board, entity_board, ship_board, turtl, clock, fps, pix_x, pix_y, pos, buttons_pos, buttons_k,
    ...
    if buttons_k[0] == 0:
        screen.blit(load_sprite('assets/texture/buttons/save.png'), buttons_pos[0])
    else:
        screen.blit(load_sprite('assets/texture/buttons/save_1.png'), buttons_pos[0])
    pygame.display.flip()
    clock.tick(fps)
...
def load_game(block_board, entity_board, turtl):
    ...
    if os.path.isfile(path_file + "save/save"):
        with open(path_file + "save/save") as save:
    ...
    elif os.path.exists(path_file + 'save'):
        save_game(block_board, entity_board, turtl)
    else:
        os.mkdir(path_file + 'save')
        save_game(block_board, entity_board, turtl)
...
def save_game(block_board, entity_board, turtl):
    ...
    entity_keys = {None: '.', "brevno": '0', "brevno_2": '2', "brevno_3": '3', "brevno_4": '4',
                   ...
                   "dry_bush": 'u'}
    if not os.path.exists(path_file + 'save'):
        os.mkdir(path_file + 'save')
    with open(path_file + f"save/save", "w") as save:
...
def final_screen(screen, clock):
    fon = pygame.transform.scale(load_sprite('assets/texture/screens/final_fon.png'),
                                 (screen.get_width() + 300, screen.get_height()))
    ship_im = [pygame.transform.scale(load_sprite('assets/texture/screens/ship_1.png'),
                                      (screen.get_width() * 0.4, screen.get_height() * 0.4)),
               pygame.transform.scale(load_sprite('assets/texture/screens/ship_2.png'),
                                      (screen.get_width() * 0.4, screen.get_height() * 0.4))]
    ...
    while True:
        ...
        if buttons_k == 0:
            screen.blit(load_sprite('assets/texture/buttons/exit_f.png'), buttons_pos[0])
        else:
            screen.blit(load_sprite('assets/texture/buttons/exit_f2.png'), buttons_pos[0])


# стыртовое меню игры
def start_screen(screen, clock):
    fon = pygame.transform.scale(load_sprite('assets/texture/screens/fon.png'),
                                 (5000, screen.get_height()))
    plot_img = pygame.transform.rotate(load_sprite('assets/texture/entity/plot.png'), 270)
    turtle_anim = [
        pygame.transform.rotate(load_sprite('assets/texture/turtle/turtle_' + str(i) + '.png'),
                                270) for i in range(1, 9)]
    plot_anim = [pygame.transform.rotate(load_sprite('assets/texture/entity/plot_' + str(i) + '.png'),
                                         270) for i in range(1, 3)]
    turt = pygame.transform.rotate(load_sprite('assets/texture/turtle/turtle_1.png'), 270)
    ...
    while True:
        ...
        if buttons_k1 == 0:
            screen.blit(load_sprite('assets/texture/buttons/new_game.png'), buttons_pos[0])
        else:
            screen.blit(load_sprite('assets/texture/buttons/new_game_1.png'), buttons_pos[0])

        if buttons_k2 == 0:
            screen.blit(load_sprite('assets/texture/buttons/load_game_1.png'), buttons_pos[1])
        else:
            screen.blit(load_sprite('assets/texture/buttons/load_game.png'), buttons_pos[1])

        if buttons_k3 == 0:
            screen.blit(load_sprite('assets/texture/buttons/how_to_play.png'), buttons_pos[2])
        else:
            screen.blit(load_sprite('assets/texture/buttons/how_to_play_1.png'), buttons_pos[2])

        if kk:
            screen.blit(load_sprite('assets/texture/screens/explanatory_card.png'),
                        (screen.get_width() - 510,
                         (
...
def died_screen(screen):
    fon = load_sprite('assets/texture/screens/died.png')
    buttons_k1 = 0
    ...
    while True:
        ...
        if buttons_k1 == 0:
            screen.blit(load_sprite('assets/texture/buttons/restart.png'), buttons_pos[0])
        else:
            screen.blit(load_sprite('assets/texture/buttons/restart_1.png'), buttons_pos[0])
